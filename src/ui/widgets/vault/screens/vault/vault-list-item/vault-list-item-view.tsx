...
export const VaultListItemView = ({ label, iconName, count, href }: Props) => (
	<Link href={href} asChild>
		<Pressable className="bg-surface-500 flex-row rounded-lg m-1 items-center justify-between p-4 border-b border-background-500">
